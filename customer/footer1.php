                    ...
                    <li>
                        <?php
                           if(!isset($_SESSION['customer_email'])){
                              ...
                              echo"<a href='account.php?edit_acc'>Аккаунт</a>";
                           }
                        ?>
                    </li>
                </ul>               
                    ...
                    <li>
                        <?php
                           if(!isset($_SESSION['customer_email'])){
                              ...
                              echo"<a href='account.php?edit_acc'> Налаштування аккаунту </a>";
                           }
                           ?>
                    </li>
                </ul>
...
<div id="copyright">
    <div class="container">
        <div class="footer-copyright text-center py-3 mdb-color indigo lighten-3 ">© 2021 Copyright:
